...
In her later years, Eleanor became passionate about preserving Georgian cultural traditions. She organized community events, taught traditional cooking classes, and mentored young women in her neighborhood. Her legacy lives on through the countless lives she touched and the traditions she helped preserve for future generations.`,
    ...
    family: [
      { name: "George Thompson", relation: "Husband", image: "/placeholder.svg?height=60&width=60" },
      { name: "Maria Kvirikashvili", relation: "Daughter", image: "/placeholder.svg?height=60&width=60" },
      { name: "David Thompson", relation: "Son", image: "/placeholder.svg?height=60&width=60" },
      { name: "Anna Georgadze", relation: "Daughter", image: "/placeholder.svg?height=60&width=60" },
      { name: "Michael Thompson", relation: "Son", image: "/placeholder.svg?height=60&width=60" },
    ],
    achievements: [
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Demo Banner */}
      <div className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white py-3">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium">This is how your memorial will look to visitors</span>
            </div>
            <Link href="/">
              <Button
                variant="outline"
                            ...
                            {memorial.images.map((image, index) => (
                              <button
                                ...
                                className={`flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden border-2 ${
                                  index === currentImageIndex ? "border-rose-500" : "border-gray-200"
                                }`}
                              >
                                <img
                      ...
                      <TabsContent value="video" className="mt-6">
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">A heartfelt message recorded for the family</p>
                          </div>
                        </div>
                      </TabsContent>
                    </Tabs>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-xs text-gray-500">This is a demo memorial showing premium features</p>
                    </div>
                  </CardContent>
                </Card>
              </motion.div>
