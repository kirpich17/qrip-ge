    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-indigo-900 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center text-gray-400 hover:text-gray-200 mb-6">
          ...
          <p className="text-gray-400 mt-2">Secure login for system administrators</p>
        </div>
